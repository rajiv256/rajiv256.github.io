...
<figure>[![Figure 1: Seesaw gate architecture.](images/seesaw_gate.png){alt="Figure: Reaction-Diffusion patterns in a Lotka-Volterra oscillator."}](Figure%201)</figure>
...
![Figure 2: Reaction-Diffusion patterns in a Lotka-Volterra oscillator.](images/reactiondiffusion.png)
